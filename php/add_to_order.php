...
if ($quantity < 1) {
    header("Location: ../Product Details.php?id=$productID&order=invalid_quantity");
    exit();
}
...
if ((int)$product['stock'] <= 0) {
    header("Location: ../Product Details.php?id=$productID&order=no_stock");
    exit();
}
...
if (mysqli_query($conn, $sql)) {
    ...
    $update_stock = "UPDATE producttbl 
